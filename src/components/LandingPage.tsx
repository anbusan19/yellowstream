...
import { TrendingUp, Flame, Star, Filter, Grid, List } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              The first Web3-powered live streaming platform with gasless gifts and real-time creator earnings powered by
                <br />
                <h2 className="text-4xl md:text-5xl font-extrabold text-yellow-400 tracking-tight">Yellow</h2>
              </h2>
            </div>
